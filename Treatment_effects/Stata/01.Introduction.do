/*==============================================================================
    Project:    Treatment effects: Introduction
    Author:     Shaun Scholes
    Date:       August 2026
    Purpose:    Estimate treatment effects in Stata
    Input:      cattaneo2.dta
    Output:     Estimates
	Location:   "C:/Causal_Inference/Treatment_effects/code/01.Introduction"
==============================================================================*/
...
adopath + "C:/Users/sscho/OneDrive - University College London/Learning/Software/Stata/ado files"
adopath + "C:/Users/sscho/OneDrive - University College London/StataMP17/"
adopath + "C:/Users/sscho/OneDrive - University College London/StataMP18/"
...
*erase all .dta files in outputs folder.

local files : dir "${outputs}" files "*.dta"
