#==============================================================================
#Project:    Treatment effects in R
#Author:     Shaun Scholes
#Date:       August 2026
#Purpose:    Estimate treatment effects in R
#Input:      mosquito_nets.csv
#Output:     Estimates
#Location:   "C:/Causal_Inference/Treatment_effects/code/Mosquito Example"
